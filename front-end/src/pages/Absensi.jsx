  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Catat kehadiran siswa per kelas</p>
      </div>
                        ...
                        <tr key={siswaItem.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <select
                              ...
                              className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(absensiItem?.status || 'hadir')}`}
                            >
